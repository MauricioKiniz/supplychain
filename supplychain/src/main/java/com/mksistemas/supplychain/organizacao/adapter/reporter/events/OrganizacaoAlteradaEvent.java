...
public class OrganizacaoAlteradaEvent extends OrganizacaoEvent {

	@Generated("SparkTools")
	private OrganizacaoAlteradaEvent(Builder builder) {
	...
	public static final class Builder {
		...
		public OrganizacaoAlteradaEvent build() {
			return new OrganizacaoAlteradaEvent(this);
		}
	}
