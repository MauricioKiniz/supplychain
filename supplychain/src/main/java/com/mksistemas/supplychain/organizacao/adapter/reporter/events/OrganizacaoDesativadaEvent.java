...
public class OrganizacaoDesativadaEvent extends OrganizacaoEvent {

	@Generated("SparkTools")
	private OrganizacaoDesativadaEvent(Builder builder) {
	...
	public static final class Builder {
		...
		public OrganizacaoDesativadaEvent build() {
			return new OrganizacaoDesativadaEvent(this);
		}
	}
