...
import com.mksistemas.supplychain.organizacao.adapter.reporter.events.OrganizacaoAtivadaEvent;
import com.mksistemas.supplychain.organizacao.application.ativar.AtivarOrganizacaoReporter;
import com.mksistemas.supplychain.organizacao.domain.Organizacao;

@Component
class AtivarOrganizacaoReporterImpl
		implements AtivarOrganizacaoReporter, BaseReporterEvent<OrganizacaoAtivadaEvent, Organizacao> {

	private final ApplicationEventPublisher applicationEventPublisher;

	public AtivarOrganizacaoReporterImpl(ApplicationEventPublisher applicationEventPublisher) {
	...
	public void reportEvent(Result<Void, Organizacao> eventToReport) {
		publicarEmCasoSucesso(eventToReport,
				organizacao -> OrganizacaoAtivadaEvent.builder().withAtivo(organizacao.isAtivo())
