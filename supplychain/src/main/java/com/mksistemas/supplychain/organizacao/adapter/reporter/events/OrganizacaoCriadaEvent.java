...
public class OrganizacaoCriadaEvent extends OrganizacaoEvent {
	@Generated("SparkTools")
	private OrganizacaoCriadaEvent(Builder builder) {
	...
	public static final class Builder {
		...
		public OrganizacaoCriadaEvent build() {
			return new OrganizacaoCriadaEvent(this);
		}
	}
